/*TO DO: 1. Last movement step is just data entry. 3. Styling. 4. Optimization.*/

/*Use the find feature to move to "ptwoclick" and start working on those sections to make the like peightclick's 8-5. 
After that maybe shorten the card sections. If not then look into skills because the game should be done at that 
point aside from the optional skills, styling, and optimization.*/
var power = [];
...
document.querySelectorAll('.trash').forEach(function(card) {
  card.addEventListener('click', function() {
    if(this.id='nr1') {
      trashZone = trashZone.filter(a => {return a !== 1});
    }
    this.remove();
    testDeck = trashZone;
    shuffle1();
...
let handToBattleP11 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr1'});
    power.push(1);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP11 = function() {
  power = power.filter(a => {return a !== 1});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP12 = function () {
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr2'});
    power.push(2);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP12 = function() {
  power = power.filter(a => {return a !== 2});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP13 = function () {
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr3'});
    power.push(3);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP13 = function() {
  power = power.filter(a => {return a !== 3});
  this.remove();
  arts -= 1;
  powerTotal();
...
let handToBattleP14 = function () {
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr4'});
    power.push(4);
    powerTotal();
    this.remove();
...
let battleToHandP14 = function() {
  power = power.filter(a => {return a !== 4});
  this.remove();   
  powerTotal();
...
let handToBattleP15 = function () {
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr5'});
    power.push(5);
    powerTotal();
    this.remove();
...
let battleToHandP15 = function() {
  power = power.filter(a => {return a !== 5});
  this.remove();   
  powerTotal();
...
let handToBattleP16 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr6'});
    power.push(6);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP16 = function() {
  power = power.filter(a => {return a !== 6});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP17 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr7'});
    power.push(7);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP17 = function() {
  power = power.filter(a => {return a !== 7});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP18 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr8'});
    power.push(8);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP18 = function() {
  power = power.filter(a => {return a !== 8});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP19 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr9'});
    power.push(9);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP19 = function() {
  power = power.filter(a => {return a !== 9});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP110 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr10'});
    power.push(10);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP110 = function() {
  power = power.filter(a => {return a !== 10});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP111 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr11'});
    power.push(11);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP111 = function() {
  power = power.filter(a => {return a !== 11});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP112 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr12'});
    power.push(12);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP112 = function() {
  power = power.filter(a => {return a !== 12});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP113 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr13'});
    power.push(13);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP113 = function() {
  power = power.filter(a => {return a !== 13});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP114 = function () {
    ...
    if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr14'});
    power.push(14);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP114 = function() {
  power = power.filter(a => {return a !== 14});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP115 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr15'});
    power.push(15);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP115 = function() {
  power = power.filter(a => {return a !== 15});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP116 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr16'});
    power.push(16);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP116 = function() {
  power = power.filter(a => {return a !== 16});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP117 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr17'});
    power.push(17);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP117 = function() {
  power = power.filter(a => {return a !== 17});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP118 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr18'});
    power.push(18);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP118 = function() {
  power = power.filter(a => {return a !== 18});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP119 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr19'});
    power.push(19);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP119 = function() {
  power = power.filter(a => {return a !== 19});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP120 = function () {
  ...
  if(power.length <= 2 && battleTime == 1) {
    hand = hand.filter(a => {return a !== 'nr20'});
    power.push(20);
    powerTotal();
    arts += 1;
    this.remove();
...
let battleToHandP120 = function() {
  power = power.filter(a => {return a !== 20});
  this.remove();   
  powerTotal();
  arts -= 1;
...
let handToBattleP21 = function () {
  ...
  hand2 = hand2.filter(a => {return a !== 'n2r1'});
  power2.push(1);
  powerTotal2();
  this.remove();
...
let battleToHandP21 = function() {
  power2 = power2.filter(a => {return a !== 1});
  this.remove();   
  powerTotal2();
...
let handToBattleP22 = function () {
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r2'});
    power2.push(2);
    powerTotal2();
    this.remove();
...
let battleToHandP22 = function() {
  power2 = power2.filter(a => {return a !== 2});
  this.remove();   
  powerTotal2();
...
let handToBattleP23 = function () {
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r3'});
    power2.push(3);
    powerTotal2();
    this.remove();
...
let battleToHandP23 = function() {
  power2 = power2.filter(a => {return a !== 3});
  this.remove();   
  powerTotal2();
...
let handToBattleP24 = function () {
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r4'});
    power2.push(4);
    powerTotal2();
    this.remove();
...
let battleToHandP24 = function() {
  power2 = power2.filter(a => {return a !== 4});
  this.remove();   
  powerTotal2();
...
let handToBattleP25 = function () {
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r5'});
    power2.push(5);
    powerTotal2();
    this.remove();
...
let battleToHandP25 = function() {
  power2 = power2.filter(a => {return a !== 5});
  this.remove();   
  powerTotal2();
...
let handToBattleP26 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r6'});
    power2.push(6);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP26 = function() {
  power2 = power2.filter(a => {return a !== 6});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP27 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r7'});
    power2.push(7);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP27 = function() {
  power2 = power2.filter(a => {return a !== 7});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP28 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r8'});
    power2.push(8);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP28 = function() {
  power2 = power2.filter(a => {return a !== 8});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP29 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r9'});
    power2.push(9);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP29 = function() {
  power2 = power2.filter(a => {return a !== 9});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP210 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r10'});
    power2.push(10);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP210 = function() {
  power2 = power2.filter(a => {return a !== 10});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP211 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r11'});
    power2.push(11);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP211 = function() {
  power2 = power2.filter(a => {return a !== 11});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
if(power2.length <= 2 && battleTime == 1) {
  hand2 = hand2.filter(a => {return a !== 'n2r12'});
  power2.push(12);
  powerTotal2();
  arts += 1;
  this.remove();
  ...
  let inBattle = document.createElement('img');
  inBattle.onclick=battleToHandP212;       
  inBattle.id="n2r12";
  inBattle.className="card"; 
  inBattle.src="https://www.wackyprint.com/designcodes/0/1/110/11100212.png";
...
let battleToHandP212 = function() {
  power2 = power2.filter(a => {return a !== 12});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP213 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r13'});
    power2.push(13);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP213 = function() {
  power2 = power2.filter(a => {return a !== 13});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP214 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r14'});
    power2.push(14);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP214 = function() {
  power2 = power2.filter(a => {return a !== 14});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP215 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r15'});
    power2.push(15);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP215 = function() {
  power2 = power2.filter(a => {return a !== 15});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
//End of player 2 card 15 section
...
let handToBattleP216 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r16'});
    power2.push(16);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP216 = function() {
  power2 = power2.filter(a => {return a !== 16});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP217 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r17'});
    power2.push(17);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP217 = function() {
  power2 = power2.filter(a => {return a !== 17});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP218 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r18'});
    power2.push(18);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP218 = function() {
  power2 = power2.filter(a => {return a !== 18});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP219 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r19'});
    power2.push(19);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP219 = function() {
  power2 = power2.filter(a => {return a !== 19});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
let handToBattleP220 = function () {
  ...
  if(power2.length <= 2 && battleTime == 1) {
    hand2 = hand2.filter(a => {return a !== 'n2r20'});
    power2.push(20);
    powerTotal2();
    arts += 1;
    this.remove();
...
let battleToHandP220 = function() {
  power2 = power2.filter(a => {return a !== 20});
  this.remove();   
  powerTotal2();
  arts -= 1;
...
function startBattle() {
  if(power.length == 3 && power2.length == 3) {
    ...
    if(pOneTotal > pTwoTotal && whoTurn == 1) {
      alert(`Player 1 wins battle ${pOneTotal} to ${pTwoTotal}`);

      let pending = document.querySelector('.pending-move').id;
      let selected = document.querySelector('.selected-move').id;
      let transferList = document.getElementById(pending).classList;

      document.getElementById(selected).className = transferList;

      document.getElementById(pending).className = "panel";

      document.querySelectorAll('.panel').forEach(panel => {panel.classList.remove('pending-move')});

      phaseChanger();
    } else if(pOneTotal < pTwoTotal && whoTurn == 1) {
    ...
    if(pOneTotal < pTwoTotal && whoTurn == 2) {
      alert(`Player 2 wins battle ${pTwoTotal} to ${pOneTotal}`);
      ...
      phaseChanger();
    } else if(pOneTotal > pTwoTotal && whoTurn == 2) {
      alert(`Player 1 wins battle ${pOneTotal} to ${pTwoTotal}`);
...
//Player one movable 2-3
    ...
    (panelTwo.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player one movable 3-1
    ...
    (panelThree.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player two movable 3-2
    ...
    (panelThree.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelTwo.classList.contains('occupied-p21') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelThree.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelTwo.classList.contains('occupied-p22') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelThree.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelThree.classList.add('pending-move');
...
(panelEight.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player one movable 4-3
    ...
    (!panelThree.classList.contains('occupied-p12') && (!panelThree.classList.contains('occupied-p13') &&
    (panelFour.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player two movable 4-3
    if(!panelThree.classList.contains('occupied-p21') && (!panelThree.classList.contains('occupied-p22') &&
    (panelFour.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelThree.classList.contains('occupied-p21') && (!panelThree.classList.contains('occupied-p23') &&
    (panelFour.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelThree.classList.contains('occupied-p22') && (!panelThree.classList.contains('occupied-p23') &&
    (panelFour.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelFour.classList.add('pending-move');
...
//Player one movable 5-2
    ...
    (!panelTwo.classList.contains('occupied-p12') && (!panelTwo.classList.contains('occupied-p13') &&
    (panelFive.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player two movable 5-2
    if(!panelTwo.classList.contains('occupied-p21') && (!panelTwo.classList.contains('occupied-p22') &&
    (panelFive.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelTwo.classList.contains('occupied-p21') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelFive.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelTwo.classList.contains('occupied-p22') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelFive.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelFive.classList.add('pending-move');
...
//Player one movable 6-2
    ...
    (!panelTwo.classList.contains('occupied-p12') && (!panelTwo.classList.contains('occupied-p13') &&
    (panelSix.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
      panelSix.classList.add('pending-move');

      panelTwo.classList.add('movable');
    };
//End of player one movable 6-2

//Player two movable 6-2
    if(!panelTwo.classList.contains('occupied-p21') && (!panelTwo.classList.contains('occupied-p22') &&
    (panelSix.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelTwo.classList.contains('occupied-p21') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelSix.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelTwo.classList.contains('occupied-p22') && (!panelTwo.classList.contains('occupied-p23') &&
    (panelSix.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelSix.classList.add('pending-move');
...
//Player one movable 7-3
    ...
    (!panelThree.classList.contains('occupied-p12') && (!panelThree.classList.contains('occupied-p13') &&
    (panelSeven.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player two movable 7-3
    if(!panelThree.classList.contains('occupied-p21') && (!panelThree.classList.contains('occupied-p22') &&
    (panelSeven.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelThree.classList.contains('occupied-p21') && (!panelThree.classList.contains('occupied-p23') &&
    (panelSeven.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelThree.classList.contains('occupied-p22') && (!panelThree.classList.contains('occupied-p23') &&
    (panelSeven.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelSeven.classList.add('pending-move');
...
//Player two movable 8-5
    if(!panelFive.classList.contains('occupied-p21') && (!panelFive.classList.contains('occupied-p22') &&
    (panelEight.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelFive.classList.contains('occupied-p21') && (!panelFive.classList.contains('occupied-p23') &&
    (panelEight.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelFive.classList.contains('occupied-p22') && (!panelFive.classList.contains('occupied-p23') &&
    (panelEight.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelEight.classList.add('pending-move');
...
//Player one movable 9-5
    ...
    (!panelFive.classList.contains('occupied-p12') && (!panelFive.classList.contains('occupied-p13') &&
    (panelNine.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
      panelNine.classList.add('pending-move');
...
//Player one movable 10-6
    ...
    (!panelSix.classList.contains('occupied-p12') && (!panelSix.classList.contains('occupied-p13') &&
    (panelTen.classList.contains('occupied-p11')) && turnPhase == 2) && whoTurn == 1))))) {
...
//Player two movable 10-6
    if(!panelSix.classList.contains('occupied-p21') && (!panelSix.classList.contains('occupied-p22') &&
    (panelTen.classList.contains('occupied-p23')) && turnPhase == 2 ||
    (!panelSix.classList.contains('occupied-p21') && (!panelSix.classList.contains('occupied-p23') &&
    (panelTen.classList.contains('occupied-p22')) && turnPhase == 2 ||                                        
    (!panelSix.classList.contains('occupied-p22') && (!panelSix.classList.contains('occupied-p23') &&
    (panelTen.classList.contains('occupied-p21')) && turnPhase == 2) && whoTurn == 2))))) {
      panelTen.classList.add('pending-move');
...
//End of start battle
      ...
      */
      ...
      document.getElementById('nr1').removeEventListener('click', movement);
      }
...
function removeMovable() {
  ...
  panel.classList.remove('movable');
  });
}
    ...
    function discardListener(servant, move) {
      ...
      } else if(servant == 'artoria' && whoTurn == 1) {
      if(document.getElementById('nr6') !== null) { 
      ...
      } else if(servant == 'gilgamesh' && whoTurn == 1) {
        if(document.getElementById('nr11') !== null) { 
        ...
        } else if(servant == 'asterios' && whoTurn == 1) {
          ...
          } else if(servant == 'mash2' && whoTurn == 2) {
            if(document.getElementById('n2r1') !== null) { 
              document.getElementById('n2r1').addEventListener('click', move);
            }
             
            if(document.getElementById('n2r2') !== null) {
              document.getElementById('n2r2').addEventListener('click', move);
            }
             
            if(document.getElementById('n2r3') !== null) {
              document.getElementById('n2r3').addEventListener('click', move);
            }
             
            if(document.getElementById('n2r4') !== null) {
              document.getElementById('n2r4').addEventListener('click', move);
            }
             
            if(document.getElementById('n2r5') !== null) {
              document.getElementById('n2r5').addEventListener('click', move);
            }
            } else if(servant == 'artoria2' && whoTurn == 2) {
            if(document.getElementById('n2r6') !== null) { 
                document.getElementById('n2r6').addEventListener('click', move);
              }
               
              if(document.getElementById('n2r7') !== null) {
                document.getElementById('n2r7').addEventListener('click', move);
              }
               
              if(document.getElementById('n2r8') !== null) {
                document.getElementById('n2r8').addEventListener('click', move);
              }
               
              if(document.getElementById('n2r9') !== null) {
                document.getElementById('n2r9').addEventListener('click', move);
              }
               
              if(document.getElementById('n2r10') !== null) {
                document.getElementById('n2r10').addEventListener('click', move);
              }
            } else if(servant == 'gilgamesh2' && whoTurn == 2) {
              if(document.getElementById('n2r11') !== null) { 
                  document.getElementById('n2r11').addEventListener('click', move);
                }
                 
                if(document.getElementById('n2r12') !== null) {
                  document.getElementById('n2r12').addEventListener('click', move);
                }
                 
                if(document.getElementById('n2r13') !== null) {
                  document.getElementById('n2r13').addEventListener('click', move);
                }
                 
                if(document.getElementById('n2r14') !== null) {
                  document.getElementById('n2r14').addEventListener('click', move);
                }
                 
                if(document.getElementById('n2r15') !== null) {
                  document.getElementById('n2r15').addEventListener('click', move);
                }
              } else if(servant == 'asterios2' && whoTurn == 2) {
                if(document.getElementById('n2r16') !== null) { 
                    document.getElementById('n2r16').addEventListener('click', move);
                  }
                   
                  if(document.getElementById('n2r17') !== null) {
                    document.getElementById('n2r17').addEventListener('click', move);
                  }
                   
                  if(document.getElementById('n2r18') !== null) {
                    document.getElementById('n2r18').addEventListener('click', move);
                  }
                   
                  if(document.getElementById('n2r19') !== null) {
                    document.getElementById('n2r19').addEventListener('click', move);
                  }
                   
                  if(document.getElementById('n2r20') !== null) {
                    document.getElementById('n2r20').addEventListener('click', move);
                  }
                }
    }
...
const movement = function() {
  ...
  if(whoTurn == 1 && 
  !document.querySelector('.selected-move').classList.contains('occupied-p21') && 
  !document.querySelector('.selected-move').classList.contains('occupied-p22') && 
  !document.querySelector('.selected-move').classList.contains('occupied-p23')) {
    
    document.getElementById(selected).className = transferList;

    document.getElementById(pending).className = "panel";

    trashZone.push(this.id);

    hand = hand.filter(a => a !== this.id); 
    ...
    document.querySelectorAll('.card').forEach(card => {card.removeEventListener('click', movement)});

    phaseChanger();
  } else if(whoTurn == 2 && 
  !document.querySelector('.selected-move').classList.contains('occupied-p11') && 
  !document.querySelector('.selected-move').classList.contains('occupied-p12') && 
  !document.querySelector('.selected-move').classList.contains('occupied-p13')) {
      
    document.getElementById(selected).className = transferList;
  
    document.getElementById(pending).className = "panel";
  
    trashZone2.push(this.id);

    hand2 = hand2.filter(a => a !== this.id);
    ...
    phaseChanger();
  } else if(whoTurn == 1 && battleTime == 0) {
    battle();
  ...
  } else if(whoTurn == 2 && battleTime == 0) {
    battle();
  ...
  if(panelOne.classList.contains('occupied-p11') ||
  panelOne.classList.contains('occupied-p12') ||
  panelOne.classList.contains('occupied-p13')) {
    oneVictory();
  }

  if(panelEleven.classList.contains('occupied-p11') ||
  panelEleven.classList.contains('occupied-p12') ||
  panelEleven.classList.contains('occupied-p13')) {
    twoVictory();
  }
}
...
function startMove(id) {
  document.querySelectorAll('.panel').forEach(panel => {panel.classList.remove('selected-move')});
  tempId = document.querySelector('.pending-move').id;

  if(document.getElementById(id).classList.contains('movable')) {

    document.getElementById(id).classList.add('selected-move');

    if(whoTurn == 1 && document.getElementById(tempId).classList.contains('pending-move') && (document.getElementById(tempId).classList.contains("mash") && (document.getElementById('nr1') !== null || document.getElementById('nr2') !== null || document.getElementById('nr3') !== null || document.getElementById('nr4') !== null || document.getElementById('nr5') !== null))) {
      discardAlert('Mash');

      discardListener('mash', movement);
    }

    if(whoTurn == 2 && document.getElementById(tempId).classList.contains('pending-move') && document.getElementById(tempId).classList.contains('mash2') && (document.getElementById('n2r1') !== null || document.getElementById('n2r2') !== null || document.getElementById('n2r3') !== null || document.getElementById('n2r4') !== null || document.getElementById('n2r5') !== null)) {
      discardAlert('Mash');

      discardListener('mash2', movement);
    }




    if(whoTurn == 1 && document.getElementById(tempId).classList.contains('pending-move') && (document.getElementById(tempId).classList.contains("artoria") && (document.getElementById('nr6') !== null || document.getElementById('nr7') !== null || document.getElementById('nr8') !== null || document.getElementById('nr9') !== null || document.getElementById('nr10') !== null))) {
      discardAlert('Artoria');

      discardListener('artoria', movement);
    }

    if(whoTurn == 2 && document.getElementById(tempId).classList.contains('pending-move') && document.getElementById(tempId).classList.contains('artoria2') && (document.getElementById('n2r6') !== null || document.getElementById('n2r7') !== null || document.getElementById('n2r8') !== null || document.getElementById('n2r9') !== null || document.getElementById('n2r10') !== null)) {
      discardAlert('Artoria');

      discardListener('artoria2', movement);
    }

   
   
  
    if(whoTurn == 1 && document.getElementById(tempId).classList.contains('pending-move') && (document.getElementById(tempId).classList.contains("gilgamesh") && (document.getElementById('nr11') !== null || document.getElementById('nr12') !== null || document.getElementById('nr13') !== null || document.getElementById('nr14') !== null || document.getElementById('nr15') !== null))) {
      discardAlert('Gilgamesh');

      discardListener('gilgamesh', movement);
    }

    if(whoTurn == 2 && document.getElementById(tempId).classList.contains('pending-move') && (document.getElementById(tempId).classList.contains('gilgamesh2') && (document.getElementById('n2r11') !== null || document.getElementById('n2r12') !== null || document.getElementById('n2r13') !== null || document.getElementById('n2r14') !== null || document.getElementById('n2r15') !== null))) {
      discardAlert('Gilgamesh');

      discardListener('gilgamesh2', movement);
    }
  


    if(whoTurn == 1 && document.getElementById(tempId).classList.contains('pending-move') && (document.getElementById(tempId).classList.contains("asterios") && (document.getElementById('nr16') !== null || document.getElementById('nr17') !== null || document.getElementById('nr18') !== null || document.getElementById('nr19') !== null || document.getElementById('nr20') !== null))) {
      discardAlert('Asterios');

      discardListener('asterios', movement);
    }

    if(whoTurn == 2 && document.getElementById(tempId).classList.contains('pending-move') && document.getElementById(tempId).classList.contains('asterios2') && (document.getElementById('n2r16') !== null || document.getElementById('n2r17') !== null || document.getElementById('n2r18') !== null || document.getElementById('n2r19') !== null || document.getElementById('n2r20') !== null)) {
      discardAlert('Asterios');

      discardListener('asterios2', movement);
    }
  }
}