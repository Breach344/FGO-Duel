...
function c2hosen3() {
    if(panelThree.classList.contains('movable')) {
     ...
     if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', twoThree);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', twoThree);
     }}
   }
     
     
     
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', twoThree);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', twoThree);
     }
   }
     
     
    
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', twoThree);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', twoThree);
     }
   }
     
     
     
     if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', twoThree);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', twoThree);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', twoThree);
    }
     }
   }
   ...
   if(panelFive.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', twoFive);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', twoFive);
     }}
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', twoFive);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', twoFive);
     }
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', twoFive);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', twoFive);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', twoFive);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', twoFive);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', twoFive);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', twoSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', twoSix);
     }}
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', twoSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', twoSix);
     }
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', twoSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', twoSix);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', twoSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', twoSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', twoSix);
    }
     }
   }
   ...
   function c3hosen1() {
    if(panelOne.classList.contains('movable')) {
     ...
     if(panelThree.classList.contains('pending-move') && panelThree.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeOne);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeOne);
     }}
   }
     
     
     
   if(panelOne.classList.contains('pending-move') && panelOne.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeOne);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeOne);
     }
   }
     
     
    
   if(panelOne.classList.contains('pending-move') && panelOne.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeOne);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeOne);
     }
   }
     
     
     
     if(panelOne.classList.contains('pending-move') && panelOne.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeOne);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeOne);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeOne);
    }
     }
   }
   ...
   if(panelTwo.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeTwo);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeTwo);
     }}
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeTwo);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeTwo);
     }
   }
   ...
   if(panelTwo.classList.contains('pending-move') && panelTwo.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeTwo);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeTwo);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeTwo);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeTwo);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeTwo);
    }
     }
   }
   ...
   if(panelFour.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeFour);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeFour);
     }}
   }
     
     
     
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeFour);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeFour);
     }
   }
     
     
    
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeFour);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeFour);
     }
   }
     
     
     
     if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeFour);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeFour);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeFour);
    }
     }
   }
   ...
   if(panelFive.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeFive);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeFive);
     }}
   }
     
     
     
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeFive);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeFive);
     }
   }
     
     
    
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeFive);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeFive);
     }
   }
     
     
     
     if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeFive);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeFive);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeFive);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeSix);
     }}
   }
     
     
     
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeSix);
     }
   }
     
     
    
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeSix);
     }
   }
     
     
     
     if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeSix);
    }
     }
   }
   ...
   if(panelSeven.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', threeSeven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', threeSeven);
     }}
   }
     
     
     
   if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', threeSeven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', threeSeven);
     }
   }
     
     
    
   if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', threeSeven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', threeSeven);
     }
   }
     
     
     
     if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', threeSeven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', threeSeven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', threeSeven);
    }
     }
   }
   ...
   if(panelThree.classList.contains('movable')) {
     ...
     if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fourThree);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fourThree);
     }}
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fourThree);
     }
   ...
   document.getElementById('nr9').addEventListener('click', fourThree);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fourThree);
     }
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fourThree);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fourThree);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fourThree);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fourThree);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fourThree);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fourSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fourSix);
     }}
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fourSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fourSix);
     }
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fourSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fourSix);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fourSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fourSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fourSix);
    }
     }
   }
   ...
   if(panelSeven.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fourSeven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fourSeven);
     }}
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fourSeven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fourSeven);
     }
   }
   ...
   if(panelFour.classList.contains('pending-move') && panelFour.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fourSeven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fourSeven);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fourSeven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fourSeven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fourSeven);
    }
     }
   }
   ...
   function c5hosen2() {
    if(panelTwo.classList.contains('movable')) {
     ...
     if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveTwo);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveTwo);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveTwo);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveTwo);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveTwo);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveTwo);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveTwo);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveTwo);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveTwo);
    }
     }
   }
   ...
   if(panelThree.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveThree);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveThree);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveThree);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveThree);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveThree);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveThree);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveThree);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveThree);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveThree);
    }
     }
   }
   ...
   if(panelFour.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveFour);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveFour);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveFour);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveFour);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveFour);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveFour);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveFour);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveFour);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveFour);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveSix);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveSix);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveSix);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveSix);
    }
     }
   }
   ...
   if(panelEight.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveEight);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveEight);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveEight);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveEight);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveEight);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveEight);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveEight);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveEight);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveEight);
    }
     }
   }
   ...
   if(panelNine.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', fiveNine);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', fiveNine);
     }}
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', fiveNine);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', fiveNine);
     }
   }
   ...
   if(panelFive.classList.contains('pending-move') && panelFive.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', fiveNine);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', fiveNine);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', fiveNine);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', fiveNine);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', fiveNine);
    }
     }
   }
...
const pSixClick = function() {
   ...
   if(panelTwo.classList.contains('movable')) {
     ...
     if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixTwo);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixTwo);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixTwo);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixTwo);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixTwo);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixTwo);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixTwo);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixTwo);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixTwo);
    }
     }
   }
   ...
   if(panelThree.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixThree);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixThree);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixThree);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixThree);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixThree);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixThree);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixThree);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixThree);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixThree);
    }
     }
   }
   ...
   if(panelFour.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixFour);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixFour);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixFour);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixFour);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixFour);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixFour);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixFour);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixFour);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixFour);
    }
     }
   }
   ...
   if(panelFive.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixFive);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixFive);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixFive);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixFive);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixFive);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixFive);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixFive);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixFive);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixFive);
    }
     }
   }
   ...
   if(panelSeven.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixSeven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixSeven);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixSeven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixSeven);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixSeven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixSeven);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixSeven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixSeven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixSeven);
    }
     }
   }
   ...
   if(panelEight.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixEight);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixEight);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixEight);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixEight);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixEight);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixEight);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixEight);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixEight);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixEight);
    }
     }
   }
   ...
   if(panelNine.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixNine);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixNine);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixNine);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixNine);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixNine);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixNine);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixNine);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixNine);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixNine);
    }
     }
   }
   ...
   if(panelTen.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', sixTen);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', sixTen);
     }}
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', sixTen);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', sixTen);
     }
   }
   ...
   if(panelSix.classList.contains('pending-move') && panelSix.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', sixTen);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', sixTen);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', sixTen);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', sixTen);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', sixTen);
    }
     }
   }
...
if(panelThree.classList.contains('movable')) {
  ...
  if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("mash")) {
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', sevenThree);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', sevenThree);
  }}
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', sevenThree);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', sevenThree);
  }
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', sevenThree);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', sevenThree);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', sevenThree);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', sevenThree);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', sevenThree);
 }
  }
}
...
if(panelFour.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', sevenFour);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', sevenFour);
  }}
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', sevenFour);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', sevenFour);
  }
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', sevenFour);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', sevenFour);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', sevenFour);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', sevenFour);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', sevenFour);
 }
  }
}
...
if(panelSix.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', sevenSix);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', sevenSix);
  }}
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', sevenSix);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', sevenSix);
  }
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', sevenSix);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', sevenSix);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', sevenSix);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', sevenSix);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', sevenSix);
 }
  }
}
...
if(panelNine.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', sevenNine);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', sevenNine);
  }}
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', sevenNine);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', sevenNine);
  }
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', sevenNine);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', sevenNine);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', sevenNine);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', sevenNine);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', sevenNine);
 }
  }
}
...
if(panelTen.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', sevenTen);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', sevenTen);
  }}
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', sevenTen);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', sevenTen);
  }
}
...
if(panelSeven.classList.contains('pending-move') && panelSeven.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', sevenTen);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', sevenTen);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', sevenTen);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', sevenTen);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', sevenTen);
 }
  }
}
...
if(panelFive.classList.contains('movable')) {
  ...
  if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("mash")) {
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', eightFive);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', eightFive);
  }}
}
  
  
  
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', eightFive);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', eightFive);
  }
}
  
  
 
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', eightFive);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', eightFive);
  }
}
  
  
  
  if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("asterios")) {
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', eightFive);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', eightFive);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', eightFive);
 }
  }
}
...
if(panelSix.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', eightSix);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', eightSix);
  }}
}
...
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', eightSix);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', eightSix);
  }
}
...
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', eightSix);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', eightSix);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', eightSix);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', eightSix);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', eightSix);
 }
  }
}
...
if(panelNine.classList.contains('movable')) {
 ...
 if(document.getElementById('nr1') !== null) { 
   alert('Discard a Mash command card to move');
   document.getElementById('nr1').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr2') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr2').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr3') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr3').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr4') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr4').addEventListener('click', eightNine);
 }
  
 if(document.getElementById('nr5') !== null) {
   alert('Discard a Mash command card to move');
   
document.getElementById('nr5').addEventListener('click', eightNine);
  }}
}
...
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("artoria")) {
 if(document.getElementById('nr6') !== null) { 
   alert('Discard an Artoria command card to move');
   document.getElementById('nr6').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr7') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr7').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr8') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr8').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr9') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr9').addEventListener('click', eightNine);
 }
  
 if(document.getElementById('nr10') !== null) {
   alert('Discard an Artoria command card to move');
   
document.getElementById('nr10').addEventListener('click', eightNine);
  }
}
...
if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("gilgamesh")) {
 if(document.getElementById('nr11') !== null) { 
   alert('Discard a Gilgamesh command card to move');
   document.getElementById('nr11').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr12') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr12').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr13') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr13').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr14') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr14').addEventListener('click', eightNine);
 }
  
 if(document.getElementById('nr15') !== null) {
   alert('Discard a Gilgamesh command card to move');
   
document.getElementById('nr15').addEventListener('click', eightNine);
  }
}
 ...
 if(document.getElementById('nr16') !== null) { 
   alert('Discard an Asterios command card to move');
   document.getElementById('nr16').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr17') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr17').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr18') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr18').addEventListener('click', eightNine);
  }
  
 if(document.getElementById('nr19') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr19').addEventListener('click', eightNine);
 }
  
 if(document.getElementById('nr20') !== null) {
   alert('Discard an Asterios command card to move');
   
document.getElementById('nr20').addEventListener('click', eightNine);
 }
  }
}
...
function c9hosen11() {
    if(panelEleven.classList.contains('movable')) {
     ...
     if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineEleven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineEleven);
     }}
   }
     
     
     
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineEleven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineEleven);
     }
   }
     
     
    
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineEleven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineEleven);
     }
   }
     
     
     
     if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineEleven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineEleven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineEleven);
    }
     }
   }
   ...
   if(panelFive.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineFive);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineFive);
     }}
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineFive);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineFive);
     }
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineFive);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineFive);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineFive);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineFive);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineFive);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineSix);
     }}
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineSix);
     }
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineSix);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineSix);
    }
     }
   }
   ...
   if(panelSeven.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineSeven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineSeven);
     }}
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineSeven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineSeven);
     }
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineSeven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineSeven);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineSeven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineSeven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineSeven);
    }
     }
   }
   ...
   if(panelEight.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineEight);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineEight);
     }}
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineEight);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineEight);
     }
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineEight);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineEight);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineEight);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineEight);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineEight);
    }
     }
   }
   ...
   if(panelTen.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', nineTen);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', nineTen);
     }}
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', nineTen);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', nineTen);
     }
   }
   ...
   if(panelNine.classList.contains('pending-move') && panelNine.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', nineTen);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', nineTen);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', nineTen);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', nineTen);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', nineTen);
    }
     }
   }
   ...
   if(panelSix.classList.contains('movable')) {
     ...
     if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("mash")) {
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', tenSix);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', tenSix);
     }}
   }
     
     
     
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', tenSix);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', tenSix);
     }
   }
     
     
    
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', tenSix);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', tenSix);
     }
   }
     
     
     
     if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("asterios")) {
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoSix);
     }
   ...
   document.getElementById('nr17').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', tenSix);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', tenSix);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', tenSix);
    }
     }
   }
   ...
   if(panelSeven.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', tenSeven);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', tenSeven);
     }}
   }
   ...
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', tenSeven);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', tenSeven);
     }
   }
   ...
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', tenSeven);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', tenSeven);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoSeven);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', tenSeven);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', tenSeven);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', tenSeven);
    }
     }
   }
   ...
   if(panelNine.classList.contains('movable')) {
    ...
    if(document.getElementById('nr1') !== null) { 
      alert('Discard a Mash command card to move');
      document.getElementById('nr1').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr2') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr2').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr3') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr3').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr4') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr4').addEventListener('click', tenNine);
    }
     
    if(document.getElementById('nr5') !== null) {
      alert('Discard a Mash command card to move');
      
   document.getElementById('nr5').addEventListener('click', tenNine);
     }}
   }
   ...
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("artoria")) {
    if(document.getElementById('nr6') !== null) { 
      alert('Discard an Artoria command card to move');
      document.getElementById('nr6').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr7') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr7').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr8') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr8').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr9') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr9').addEventListener('click', tenNine);
    }
     
    if(document.getElementById('nr10') !== null) {
      alert('Discard an Artoria command card to move');
      
   document.getElementById('nr10').addEventListener('click', tenNine);
     }
   }
   ...
   if(panelTen.classList.contains('pending-move') && panelTen.classList.contains("gilgamesh")) {
    if(document.getElementById('nr11') !== null) { 
      alert('Discard a Gilgamesh command card to move');
      document.getElementById('nr11').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr12') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr12').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr13') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr13').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr14') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr14').addEventListener('click', tenNine);
    }
     
    if(document.getElementById('nr15') !== null) {
      alert('Discard a Gilgamesh command card to move');
      
   document.getElementById('nr15').addEventListener('click', tenNine);
     }
   }
    ...
    if(document.getElementById('nr16') !== null) { 
      alert('Discard an Asterios command card to move');
      document.getElementById('nr16').addEventListener('click', twoNine);
     }
     
    if(document.getElementById('nr17') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr17').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr18') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr18').addEventListener('click', tenNine);
     }
     
    if(document.getElementById('nr19') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr19').addEventListener('click', tenNine);
    }
     
    if(document.getElementById('nr20') !== null) {
      alert('Discard an Asterios command card to move');
      
   document.getElementById('nr20').addEventListener('click', tenNine);
    }
     }
   }
    ...
    if(panelFour.classList.contains('occupied-p11') || (panelFour.classList.contains('occupied-p12') ||(panelFour.classList.contains('occupied-p13') ||(panelFour.classList.contains('occupied-p21') || (panelFour.classList.contains('occupied-p22') ||(panelFour.classList.contains('occupied-p23') && (!panelFour.classList.contains('pending-move')))))))) {
      ...
      */
      ...
      if(panelEight.classList.contains('pending-move') && panelEight.classList.contains("artoria")) {
       ...
       if(document.getElementById('nr7') !== null && panelEight.classList.contains('artoria')) {
         alert('Discard an Artoria command card to move');
